...
from .keypoints import kp_connections, get_part_idxs


def mirror_hand(hand_keypoint_names, source='right', target='left'):
    return [
        name.replace(source, target) for name in hand_keypoint_names
    ]
...
FREIHAND_NAMES_LEFT = mirror_hand(
    FREIHAND_NAMES_RIGHT, 'right', 'left')
